//V1.4
// Frequency of light in synch mode (F+Fshift)/2 with F speaker frequency
//Author Baudouin  SAINTYVES 05/25/2019
//////////////////////
...
//        }
        ...
        if (Se==2){
         if (Fshift<10) {Fshift=Fshift+0.01;} else {Fshift=10;}
...
trig_period=2*(100000000/((100000000/(freq1.countToNanoseconds(freq1.read())/1000))));
